...
annotation {
    ...
    "bbox"                  : [x, y, w, h],     # The box around the masks, in XYWH format
    "area"                  : int,              # The area in pixels of the masks
    "predicted_iou"         : float,            # The model's own prediction of the masks's quality
    "stability_score"       : float,            # A measure of the masks's quality
    "crop_box"              : [x, y, w, h],     # The crop of the image used to generate the masks, in XYWH format
    "point_coords"          : [[x, y]],         # The point coordinates input to the model to generate the masks
}
```
